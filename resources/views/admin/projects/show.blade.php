                ...
                <div class="mt-4 lg:mt-0 lg:row-span-3">
                    ...
                    <div class="mt-4">
                        <h3 class="text-sm text-gray-900 font-medium">
                            <b class="text-base">Автор:</b> {{ $project->author->name }}
                        </h3>

                        <h3 class="pt-4 text-sm text-gray-900 font-medium">
                            <b class="text-base">Статус:</b> {{ $project->isPublished() }}
                        </h3>

                        <h3 class="pt-4 text-sm text-gray-900 font-medium">
                            <b class="text-base">Створено:</b> {{ $project->created_at->diffForHumans() }}
                        </h3>

                        <h3 class="pt-4 text-sm text-gray-900 font-medium">
                            <b class="text-base">Редаговано:</b> {{ $project->updated_at->diffForHumans() }}
                        </h3>
                    </div>

                    <div class="mt-4 flex">
                        <a class="mr-4 font-bold text-white py-2 px-4 bg-blue-500 rounded-xl hover:bg-blue-600"
                           href="{{ url('admin/projects/'. $project->slug . '/edit') }}">
                            Редагувати
                        </a>
